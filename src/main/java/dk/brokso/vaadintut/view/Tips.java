...
public class Tips extends VerticalLayout {
    ...
    public Tips() {
        ...
        add(new Span("Udnyt den termiske effekt !!! Denne app er skræddersyet til udnyttelse af den såkaldte \"termiske effekt\". " +
                "Termisk effekt går ud på at kroppen bruger forskellig energi på at forbrænde forskellige fødevarer." +
                "Når man spiser fedt bruges 0-3 procent af den indtagne energi til forbrænding. For kulhydrat er det mellem 5 og 10 procent. For protein er det mellem 20 og 30 procent" +
                ...
                "Det kan vistnok også lade sig gøre at få for meget protein, så kroppen har svært ved at forarbejde det." +
                "Jeg har gode erfaringer med en blanding af fedt/protein/kulhydrat på 20/30/50 procent. " ));


        add(new Span("NEAT: Et fint udtryk for ikke at ligge i sofaen - men heller ikke være igang med at træne: \"Non-exercise activity thermogenesis\". " +
