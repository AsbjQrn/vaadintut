...
public interface Food {
    ...
    default double calculateFullnessFactor(double kiloKalorierpr100Gr, double proteinPr100Gr, double dietaryfibrePr100Gr, double fatPr100Gr) {
    ...
    double getGramProtein();

    double getGramCarbonhydrates();

    double getGramFat();

    double getGramDietaryfibre();
