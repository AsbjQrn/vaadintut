...
function d2(t2) {
  ...
  else return function(r, i2) {
    if ("string" == typeof r && i2) for (var e3 in i2) {
      var o3 = i2[e3];
      if ("children" !== e3 && o3 instanceof u) i2[e3] = o3.value;
    }
    return t2.call.apply(t2, [t2, r, i2].concat([].slice.call(arguments, 2)));
  };
}
var p2;
...
Object.defineProperties(u.prototype, { $$typeof: { configurable: true, value: v2 }, type: { configurable: true, value: function(n) {
  var t2 = n.data, r = $(1);
  try {
    return t2.value;
  } finally {
...
function useComputed(n) {
  var t2 = (0, import_react.useRef)(n);
  t2.current = n;
  return (0, import_react.useMemo)(function() {
    return w(function() {
      return t2.current();
